...
const Vehicle = sequelize.define('Vehicle', {
    ...
    fuel_type: { type: DataTypes.ENUM('petrol', 'diesel', 'electric', 'hybrid', 'Elektryczny', 'Diesel', 'Hybryda', 'Benzyna'), allowNull: false },
    seats: { type: DataTypes.INTEGER, allowNull: false },
    transmission: { type: DataTypes.ENUM('manual', 'automatic', 'Automatyczna', 'Ręczna'), allowNull: false },
